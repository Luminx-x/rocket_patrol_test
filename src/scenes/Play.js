class Play extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('spaceship', './assets/caravan.png');
        this.load.image('starfield', './assets/grass.png');
        this.load.image('tumbleweed', './assets/tumbleweed.png');
        this.load.spritesheet('explosion', './assets/breakingdown.png', {frameWidth: 64, frameHeight: 32, startFrame: 0, endFrame: 9});
      }
    ...
    create() {
        ...
        this.ship04 = new Spaceship(this, game.config.width, borderUISize*6 + borderPadding*4, 'tumbleweed', 0, 30, 5).setOrigin(0,0);
        // define keys
